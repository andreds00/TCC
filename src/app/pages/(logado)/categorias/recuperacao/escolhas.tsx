...
const ACTIVITIES: Record<string, ActivityConfig> = {
  crioterapia: {
    title: 'Crioterapia',
    description:
      'Locais de crioterapia para recuperação muscular e alívio de dores.',
    query: 'crioterapia|recuperação muscular|alívio de dores',
    fallback: [
      {
        id: 'refresh-cryotherapy',
        name: 'Refresh Cryotherapy',
        address: 'Jd. das orquídeas, 123 - Centro',
        highlight: 'Sessões de crioterapia para atletas.',
        extra: 'Abre às 07h',
      ...
      },
      {
        ...
        highlight: 'Sessões de crioterapia para recuperação muscular.',
      ...
      },
      {
        id: 'frost-therapy',
        name: 'Frost Therapy',
        address: 'Av. dos Campeões, 789 - Bairro Forte',
        highlight: 'Sessões de crioterapia avançadas.',
  ...
  massagem: {
    title: 'Massagem',
    description:
      'Locais de massagem terapêutica para relaxamento e recuperação muscular.',
    query: 'massagem terapêutica|relaxamento|recuperação muscular',
    fallback: [
      {
        id: 'relax-massage',
        name: 'Relax Massage',
        address: 'ABC Street, 250 - Jardim Primavera',
        highlight: 'Sessões de massagem terapêutica para todos os níveis.',
        extra: 'Primeira sessão experimental',
        location: { lat: -23.5654, lng: -46.6598 },
      },
      {
        id: 'relaxamento-total',
        name: 'Relaxamento Total',
        address: 'Av. Paulista, 300 - Centro',
        highlight: 'Sessões de massagem terapêutica avançadas.',
      ...
      },
      {
        ...
        highlight: 'Sessões de massagem terapêutica personalizadas.',
  ...
  liberacao: {
    title: 'Liberação Muscular',
    description:
      'Locais de liberação muscular para alívio de tensões e dores.',
    query: 'liberação muscular|alívio de tensões|alívio de dores',
    fallback: [
      {
        id: 'muscle-release-center',
        name: 'Muscle Release Center',
        address: 'Rua das Acácias, 250 - Jardim Primavera',
        highlight: 'Sessões de liberação muscular para todos os níveis.',
        extra: 'Primeira sessão experimental',
        location: { lat: -23.5654, lng: -46.6598 },
      },
      {
        ...
        name: 'Tension Relief',
        address: 'Av. Paulista, 300 - Centro',
        highlight: 'Sessões de liberação muscular certificadas.',
        extra: 'Primeira sessão gratuita',
        location: { lat: -23.5704, lng: -46.6582 },
      },
      {
        id: 'flex-release',
        name: 'Flex Release',
        address: 'Av. Brasil, 450 - Centro',
        highlight: 'Sessões de liberação muscular personalizadas.',
        extra: 'Estacionamento próprio',
        location: { lat: -23.5721, lng: -46.6443 },
      },
    ],
...
const DEFAULT_ACTIVITY = 'liberacao';
        ...
        <ScrollView>
          {activity.fallback.map((place) => (
            <TouchableOpacity
              ...
              onPress={() =>
                router.push({
                  pathname: '/pages/(logado)/categorias/recuperacao/horarios',
                  params: {
