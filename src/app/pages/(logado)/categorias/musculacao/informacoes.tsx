...
export default function InformacoesMusculação() {
    const router = useRouter();
  return (
    <SafeAreaView style={styles.container}>
   
      <View style={styles.banner}>
        <Text style={styles.bannerText}> Crossfit Avançado - 9h00</Text>
      </View>

     
      <TouchableOpacity style={styles.button}>
        <Ionicons name="location-outline" size={20} color="#D9D9D9" />
        <Text style={styles.buttonText}>Mob Gym</Text>
        <MaterialIcons name="arrow-forward-ios" size={18} color="#D9D9D9" />
      </TouchableOpacity>

      <TouchableOpacity style={styles.button}>
        <Ionicons name="person-outline" size={20} color="#D9D9D9" />
        <Text style={styles.buttonText}>Instrutora Karla Magalhães</Text>
      </TouchableOpacity>
